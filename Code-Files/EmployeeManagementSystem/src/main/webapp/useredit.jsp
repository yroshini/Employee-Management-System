...
<body>
    ...
    <div id="home" class="container">
		...
		<% if(request.getAttribute("status")!=null){ %>
            ...
            <input type="text" name="mobile" pattern="[0-9]{10}" value="<%= request.getParameter("mobile") %>" required />
            ...
            <textarea name="address" rows="3" value="<%= request.getParameter("address") %>" required></textarea>
    ...
    <script>
        function showSection(sectionId) {
            ...
            const backgrounds = {
            		home: 'url(https://images.pexels.com/photos/8133880/pexels-photo-8133880.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2)',
