...
<body>
    ...
    <p>
        <strong>Email:</strong> codegnan@gmail.com<br>
        <strong>Phone:</strong> +91 9381283761<br>
        <strong>Address:</strong> Vijayawada, Andhra Pradesh, India
    </p>
</div>
    ...
    <script>
        function showSection(sectionId) {
            ...
            const backgrounds = {
            		home: 'url(https://images.pexels.com/photos/7698803/pexels-photo-7698803.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2)',
