...
<body>
	    ...
	    <table border="1">
		    <tr>
		    	...
		    	<tr>
		    		...
		    		<td> <a href='useredit.jsp?id=${employee.id}&name=${employee.name}&email=${employee.email}&password=${employee.password}&age=${employee.age}&mobile=${employee.mobile}&gender=${employee.gender}&department=${employee.department}&address=${employee.address}'>Edit</a></td>   		 
		    	</tr>
	    </table>
    </div>
    ...
    <script>
        function showSection(sectionId) {
            ...
            const backgrounds = {
            		home: 'url(https://images.pexels.com/photos/6930542/pexels-photo-6930542.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2)',
